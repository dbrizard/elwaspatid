...
.. "auto_examples/plot_3_ElasticImpact.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_plot_3_ElasticImpact.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_3_ElasticImpact.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_001.png
         :alt: plot 3 ElasticImpact
         :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_002.png
         :alt: plot 3 ElasticImpact
         :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_002.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_003.png
         :alt: Force [N]
         :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_004.png
         :alt: Velocity [m/s]
         :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_004.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_005.png
         :alt: Displacement [m]
         :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_005.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_006.png
   :alt: x = 0 m
   :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_006.png
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_007.png
   :alt: plot 3 ElasticImpact
   :srcset: /auto_examples/images/sphx_glr_plot_3_ElasticImpact_007.png
   :class: sphx-glr-single-img
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_3_ElasticImpact.py <plot_3_ElasticImpact.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_3_ElasticImpact.ipynb <plot_3_ElasticImpact.ipynb>`

...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_plot_2_SHPB.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_2_SHPB.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_2_SHPB_001.png
         :alt: Force [N]
         :srcset: /auto_examples/images/sphx_glr_plot_2_SHPB_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_2_SHPB_002.png
         :alt: Velocity [m/s]
         :srcset: /auto_examples/images/sphx_glr_plot_2_SHPB_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_2_SHPB_003.png
         :alt: Displacement [m]
         :srcset: /auto_examples/images/sphx_glr_plot_2_SHPB_003.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_2_SHPB_004.png
   :alt: plot 2 SHPB
   :srcset: /auto_examples/images/sphx_glr_plot_2_SHPB_004.png
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_2_SHPB.py <plot_2_SHPB.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_2_SHPB.ipynb <plot_2_SHPB.ipynb>`
